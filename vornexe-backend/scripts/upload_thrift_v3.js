...
const productsData = [
  { files: ['IMG_4234.PNG', 'IMG_4235.PNG'], name: 'Maroon True Faith Graphic Tee' },
  { files: ['IMG_4236.PNG'], name: 'Maroon True Face Graphic Tee' },
  { files: ['IMG_4292.PNG', 'IMG_4302.JPG', 'IMG_4303.PNG', 'IMG_4328.PNG'], name: 'Black Flaming Skull Graphic Tee' },
...
const uploadProducts = async () => {
  try {
    ...
    console.log('Finished uploading v3 products!');
    process.exit(0);
  } catch (error) {
